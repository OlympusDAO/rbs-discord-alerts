...
export const BONDS_SUBGRAPH_URL = "https://api.studio.thegraph.com/query/28103/bonds/0.0.21";
...
export const OPERATOR_CONTRACT = "0xbb47C3FFf4eF85703907d3ffca30de278b85df3f".toLowerCase();
